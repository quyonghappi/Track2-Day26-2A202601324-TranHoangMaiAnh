...
if __name__ == "__main__":
    ...
    # The current cost-table retune makes the disciplined path sustainable:
    # 9 credits x 10 rounds leaves 10 credits of headroom even without cache
    # hits.  Keep this assertion tied to the live pricing data.
